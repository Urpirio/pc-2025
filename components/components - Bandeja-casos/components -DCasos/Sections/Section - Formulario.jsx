  ...
  return (
    <section className="w-full py-5">
        <div className="border-b border-gray-300 w-full pb-5 pt-2">
            <h2 className="text-xl font-semibold text-blue-900">Formulario</h2>
            <p className="text-gray-500 text-sm">Aqui encontraras los formularios relavantes para el estado del caso</p>
        </div>
